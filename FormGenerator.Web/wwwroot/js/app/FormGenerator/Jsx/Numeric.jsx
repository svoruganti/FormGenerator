class Numeric extends FormGeneratorComponent {
    constructor(props) {
        super(props);
        ...
        return(
            <ReactBootstrap.FormGroup controlId={this.props.code} bsSize="small" className={this.getIsVisibleClassName()} validationState={this.state.validationState}>
                <ReactBootstrap.Col sm={this.props.cols}>
                    ...
                    <ReactBootstrap.FormControl type="number" name={this.props.code} value={this.state.value} onChange={this.handleControlledComponentChange.bind(this)} onBlur={this.handleBlur.bind(this)}/>
